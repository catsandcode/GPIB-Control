...
"""
for i in range(0, 3):
    sweep_parameter(set_freq_synth_frequency, np.linspace(225.0, 275.0, num=200, endpoint=True), time_constant=100,  sensitivity=0.2, load_time=4, lock_in_time=0, multiplier=1,
...
"""
for i in range(0, 3):
    sweep_parameter(set_freq_synth_frequency, np.linspace(225.0, 275.0, num=200, endpoint=True), time_constant=30,  sensitivity=0.2, load_time=4, lock_in_time=0, multiplier=1,
