...
for i in range(0, 3):
    sweep_parameter(set_freq_synth_frequency, np.linspace(12.5, 16.5, num=500, endpoint=True), time_constant=300,  sensitivity=500, load_time=0.5, lock_in_time=0.1, multiplier=1,
