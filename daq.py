...
if __name__ == '__main__':
    sweep_parameter(wrapper.set_freq_synth_frequency, generate_frequency_list(12.5, 16.5, 0.005), save_path='with_virginia_diode_high_res', power=15, sensitivity=5, multiplier=1)
