...
if __name__ == '__main__':
    sweep_parameter(wrapper.set_freq_synth_frequency, generate_frequency_list(12.5, 16.5, 0.05), save_path='with_virginia_diode', power=15, sensitivity=0.01, multiplier=1)
